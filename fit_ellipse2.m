% Credit to  Ohad Gal (2023). fit_ellipse (https://www.mathworks.com/matlabcentral/fileexchange/3215-fit_ellipse), MATLAB Central File Exchange
% Modified by Johannes Sieberer
...
squareErr = (a.*x.^2 + b .*x.*y + c .* y.^2 + d .* x * e.*y -1).^2;
err = sqrt(mean(squareErr));
